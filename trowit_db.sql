...
CREATE TABLE IF NOT EXISTS `trowit_db`.`order_physical_card` (
  ...
  PRIMARY KEY (`id`, `users_id`, `card_order_address_id`),
  INDEX `fk_order_physical_card_users1_idx` (`users_id` ASC) VISIBLE,
  INDEX `fk_order_physical_card_card_order_address1_idx` (`card_order_address_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_order_physical_card_card_order_address1`
    FOREIGN KEY (`card_order_address_id`)
    REFERENCES `trowit_db`.`card_order_address` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `trowit_db`.`order_physical_card_has_cards`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `trowit_db`.`order_physical_card_has_cards` (
  `order_physical_card_id` INT NOT NULL,
  `order_physical_card_users_id` INT NOT NULL,
  `cards_id` INT NOT NULL,
  `cards_users_id` INT NOT NULL,
  PRIMARY KEY (`order_physical_card_id`, `order_physical_card_users_id`, `cards_id`, `cards_users_id`),
  INDEX `fk_order_physical_card_has_cards_cards1_idx` (`cards_id` ASC, `cards_users_id` ASC) VISIBLE,
  INDEX `fk_order_physical_card_has_cards_order_physical_card1_idx` (`order_physical_card_id` ASC, `order_physical_card_users_id` ASC) VISIBLE,
  CONSTRAINT `fk_order_physical_card_has_cards_order_physical_card1`
    FOREIGN KEY (`order_physical_card_id` , `order_physical_card_users_id`)
    REFERENCES `trowit_db`.`order_physical_card` (`id` , `users_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_physical_card_has_cards_cards1`
    FOREIGN KEY (`cards_id` , `cards_users_id`)
    REFERENCES `trowit_db`.`cards` (`id` , `users_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
